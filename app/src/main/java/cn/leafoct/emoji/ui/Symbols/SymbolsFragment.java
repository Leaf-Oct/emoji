package cn.leafoct.emoji.ui.Symbols;
...
import cn.leafoct.emoji.databinding.FragmentSymbolsBinding;

public class SymbolsFragment extends Fragment {

    private FragmentSymbolsBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        emoji_list= EmojiList.symbols;
        RecyclerView recyclerView = binding.symbolsRecyclerview;
